...
public:
    ...
    public:
        ...
        virtual s32 getBoneIdx(const sead::SafeStringBase<char>& name) const = 0;
        ...
        virtual s32 getMaterialIdx(const sead::SafeStringBase<char>& name) const = 0;
        ...
        virtual void getName(sead::SafeStringBase<char>& name) const = 0;
